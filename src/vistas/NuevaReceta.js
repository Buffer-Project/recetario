...
export default function NuevaReceta() {
    ...
    const guardarCambios = () => {
        receta.titulo = tituloReceta
        receta.id = recetaAEditar
        receta.autor = currentUser.name
        receta.ingredientes = ingredientes
        receta.preparacion = preparacion
        receta.foto = "data:image/jpeg;base64,"
        updateReceta(receta).then(
            (res) => {
                toast.current.show({
                    severity: 'success',
                    summary: 'Exito!',

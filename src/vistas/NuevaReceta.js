...
export default function NuevaReceta() {
    ...
    const crearReceta = () => {
        const nuevaReceta = {}
        if (tituloReceta !== "") { nuevaReceta.titulo = tituloReceta}
        ...
        if (ingredientes !== [{ "ingrediente": "", "cantidad": "" }]) { nuevaReceta.ingredientes = ingredientes }
        if (preparacion !== [""]) { nuevaReceta.preparacion = preparacion }
